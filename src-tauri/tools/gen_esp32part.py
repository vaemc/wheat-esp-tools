...
def main():
    ...
    parser.add_argument('--out-string', help='out string')
    ...
    parser.add_argument('--secure', help='Require app partitions to be suitable for secure boot', nargs='?',
                        const=SECURE_V1, choices=[SECURE_V1, SECURE_V2])
    ...
    if input_is_binary:
        ...
        if not args.out_string:
            ...
            print("# succeed")
            print(PartitionTable.from_csv(csv_content.decode('utf-8')).to_csv())
